...
def analyser_modules(modules):
    ...
    if len(modules) == 0:
        ...
        temps = modules[i]["temps_moyen"]

if temps != 0:
    ratio = modules[i]["cout_moyen"] / temps
else:
    ratio = 0   # ou None selon ce que tu veux faire
        for i in range(len(modules))-1:
        ratio = module[i]["cout_moyen"] / module[i]["temps_moyen"]
        if module[i]["cout_moyen"] / module[i]["temps_moyen"] < module[i+1]["cout_moyen"] / module[i+1]["temps_moyen"]
